1. StockExchanger application was developed as as Spring Boot application. Therefore, the main class "StockExchangerApplication" should be started to launch the application.
